...
Metric & Value \\
\midrule
Oracle replay sampled-goal success rate & 1.00 \\
...
Hierarchical control reached \textbf{25\% sampled-goal success} and mean sampled-state distance \textbf{254.61}, while the matched flat controller stayed at \textbf{0\% sampled-goal success} and the labeled-only baseline also stayed at \textbf{0\% sampled-goal success}.
\end{minipage}
}
\end{center}
