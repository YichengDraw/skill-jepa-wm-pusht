...
try:
    import gym
except ImportError:  # pragma: no cover - local fallback for environments with gymnasium only
...
class PushTEnv(gym.Env):
    ...
    def _setup(self):
        ...
        else:  # pragma: no cover - pymunk>=7 switched to callback registration on Space
